...
import { ArrowRight, Clock, TrendingUp, Globe, Cpu, Zap, Search, BarChart3, Binary } from "lucide-react";
...
export default function MarketTrendsPage() {
  const filteredBlogs = blogs.filter(b => b.category.toLowerCase() === "industry trends" || b.category.toLowerCase() === "performance");
    ...
    <div className="pt-56 pb-32">
      ...
      <section className="px-8 md:px-16 mb-32 text-center">
        <div className="max-w-7xl mx-auto">
          ...
          >
            Stay ahead of the curve. We analyze the intersection of technology
            and commerce to identify the opportunities of tomorrow.
          </motion.p>
        </div>
      </section>
      ...
      <section className="px-8 md:px-16 mb-40">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-16 px-4">
            <div>
              <p className="text-primary text-xs font-bold uppercase tracking-widest mb-4">Market Intelligence</p>
              <h2 className="text-4xl md:text-5xl font-black text-foreground font-outfit">Latest Trends</h2>
            </div>
