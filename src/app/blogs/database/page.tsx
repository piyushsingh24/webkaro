...
import { ArrowRight, Clock, Database, Zap, Shield, Search, Cpu, Layers, BarChart3 } from "lucide-react";
    ...
    <div className="pt-56 pb-32">
      ...
      <section className="px-8 md:px-16 mb-32 text-center">
        <div className="max-w-7xl mx-auto">
          ...
          >
            Database <br />
            <span className="text-gradient">Optimization & Scale.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            The foundation of every great application is its data. We ensure your
            database stays fast even as your user base grows exponentially.
          </motion.p>
        </div>
      </section>
      ...
      <section className="px-8 md:px-16 mb-40">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-16 px-4">
            <div>
              <p className="text-primary text-xs font-bold uppercase tracking-widest mb-4">Data Lore</p>
              <h2 className="text-4xl md:text-5xl font-black text-foreground font-outfit">Database Insights</h2>
            </div>
