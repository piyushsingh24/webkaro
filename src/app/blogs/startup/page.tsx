...
import { ArrowRight, Clock, Rocket, Target, Users, Gem, Lightbulb, TrendingUp, ShieldCheck } from "lucide-react";
...
export default function StartupGuidesPage() {
  const filteredBlogs = blogs.filter(b => b.category.toLowerCase() === "startup strategy" || b.category.toLowerCase() === "industry trends");
    ...
    <div className="pt-56 pb-32">
      ...
      <section className="px-8 md:px-16 mb-32 text-center">
        <div className="max-w-7xl mx-auto">
          ...
          >
            The Startup <br />
            <span className="text-gradient">Launch Blueprint.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Don't just launch—dominate. We share the frameworks and strategies
            that take startups from zero to scale without the usual pitfalls.
          </motion.p>
        </div>
      </section>
      ...
      <section className="px-8 md:px-16 mb-40">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-16 px-4">
            <div>
              <p className="text-primary text-xs font-bold uppercase tracking-widest mb-4">Founder's Edge</p>
              <h2 className="text-4xl md:text-5xl font-black text-foreground font-outfit">Startup Insights</h2>
            </div>
